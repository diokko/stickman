...
class Stickman 
{
	 ...
	 */
	 public function __construct($sName,$iVictories,$iDefeats,$iActionPoint,$iMovePoint,$iPoints)
	 {
	 	$this->sName = $sName;
	 }
	 ...
	 *  $name string : name of stickman 
	 */
	 public function __construct($sName,$iVictories,$iDefeats,$iActionPoint,$iMovePoint,$aovAttributes,$iPoints,)
	 {
	 	$this->sName = $sName;
	 }
